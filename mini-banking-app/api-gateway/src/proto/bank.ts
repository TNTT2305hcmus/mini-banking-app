...
function createBaseCheckUserEmailRequest(): CheckUserEmailRequest {
  return { subjectEmail: "" };
}

export const CheckUserEmailRequest: MessageFns<CheckUserEmailRequest> = {
  encode(message: CheckUserEmailRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.subjectEmail !== "") {
      writer.uint32(10).string(message.subjectEmail);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CheckUserEmailRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCheckUserEmailRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CheckUserEmailRequest {
    return {
      subjectEmail: isSet(object.subjectEmail)
        ? globalThis.String(object.subjectEmail)
        : isSet(object.subject_email)
  ...
  toJSON(message: CheckUserEmailRequest): unknown {
    const obj: any = {};
    if (message.subjectEmail !== "") {
      obj.subjectEmail = message.subjectEmail;
    }
  ...
  create<I extends Exact<DeepPartial<CheckUserEmailRequest>, I>>(base?: I): CheckUserEmailRequest {
    return CheckUserEmailRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CheckUserEmailRequest>, I>>(object: I): CheckUserEmailRequest {
    const message = createBaseCheckUserEmailRequest();
    message.subjectEmail = object.subjectEmail ?? "";
    return message;
  },
...
function createBaseCheckUserEmailResponse(): CheckUserEmailResponse {
  return { exists: false, userId: "", status: "" };
}

export const CheckUserEmailResponse: MessageFns<CheckUserEmailResponse> = {
  encode(message: CheckUserEmailResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckUserEmailResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCheckUserEmailResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CheckUserEmailResponse {
    return {
  ...
  toJSON(message: CheckUserEmailResponse): unknown {
    const obj: any = {};
    if (message.exists !== false) {
  ...
  create<I extends Exact<DeepPartial<CheckUserEmailResponse>, I>>(base?: I): CheckUserEmailResponse {
    return CheckUserEmailResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CheckUserEmailResponse>, I>>(object: I): CheckUserEmailResponse {
    const message = createBaseCheckUserEmailResponse();
...
export const BankServiceService = {
  checkUserEmail: {
    path: "/bank.BankService/CheckUserEmail" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: CheckUserEmailRequest): Buffer =>
      Buffer.from(CheckUserEmailRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CheckUserEmailRequest => CheckUserEmailRequest.decode(value),
    responseSerialize: (value: CheckUserEmailResponse): Buffer =>
      Buffer.from(CheckUserEmailResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): CheckUserEmailResponse => CheckUserEmailResponse.decode(value),
  },
  createUser: {
...
export interface BankServiceServer extends UntypedServiceImplementation {
  checkUserEmail: handleUnaryCall<CheckUserEmailRequest, CheckUserEmailResponse>;
...
export interface BankServiceClient extends Client {
  checkUserEmail(
    request: CheckUserEmailRequest,
    callback: (error: ServiceError | null, response: CheckUserEmailResponse) => void,
  ): ClientUnaryCall;
  checkUserEmail(
    request: CheckUserEmailRequest,
    metadata: Metadata,
