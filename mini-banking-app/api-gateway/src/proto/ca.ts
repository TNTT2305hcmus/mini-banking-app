...
export function identityRoleFromJSON(object: any): IdentityRole {
  switch (object) {
    ...
    case 3:
    case "IDENTITY_ROLE_CA_ADMIN":
      return IdentityRole.IDENTITY_ROLE_CA_ADMIN;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function identityRoleToJSON(object: IdentityRole): string {
  switch (object) {
    ...
    case IdentityRole.IDENTITY_ROLE_CA_ADMIN:
      return "IDENTITY_ROLE_CA_ADMIN";
...
export const AuditEventRecord: MessageFns<AuditEventRecord> = {
  encode(message: AuditEventRecord, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.certType !== "") {
      writer.uint32(58).string(message.certType);
    }
    if (message.issuerId !== "") {
      writer.uint32(66).string(message.issuerId);
    }
    return writer;
  },
