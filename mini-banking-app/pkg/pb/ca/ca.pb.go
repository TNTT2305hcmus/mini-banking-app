...
const (
	...
	IdentityRole_IDENTITY_ROLE_CA_ADMIN   IdentityRole = 3
)
...
const file_ca_proto_rawDesc = "" +
	...
	"\x13CERT_STATUS_EXPIRED\x10\x03*\x7f\n" +
	"\fIdentityRole\x12\x19\n" +
	"\x15IDENTITY_ROLE_UNKNOWN\x10\x00\x12\x1a\n" +
	"\x16IDENTITY_ROLE_CUSTOMER\x10\x01\x12\x1c\n" +
	"\x18IDENTITY_ROLE_BANK_ADMIN\x10\x02\x12\x1a\n" +
	"\x16IDENTITY_ROLE_CA_ADMIN\x10\x032\xa5\x06\n" +
	"\tCAService\x12A\n" +
