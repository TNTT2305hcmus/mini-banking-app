...
const file_bank_proto_rawDesc = "" +
	...
	"\tfull_name\x18\x03 \x01(\tR\bfullName\"m\n" +
	...
	"\x19TRANSACTION_STATUS_FAILED\x10\x032\xd4\x02\n" +
	"\vBankService\x12?\n" +
	"\n" +
	...
	"\n" +
	"GetHistory\x12\x14.bank.HistoryRequest\x1a\x15.bank.HistoryResponse\x12N\n" +
	"\x0fListAuditEvents\x12\x1c.bank.ListAuditEventsRequest\x1a\x1d.bank.ListAuditEventsResponseB!Z\x1fmini_banking/pkg/pb/bank;bankpbb\x06proto3"
...
var file_bank_proto_goTypes = []any{
	...
	(*ListAuditEventsRequest)(nil),  // 10: bank.ListAuditEventsRequest
	(*BankAuditRecord)(nil),         // 11: bank.BankAuditRecord
	(*ListAuditEventsResponse)(nil), // 12: bank.ListAuditEventsResponse
	(*TransactionRecord)(nil),       // 13: bank.TransactionRecord
}
var file_bank_proto_depIdxs = []int32{
	0,  // 0: bank.BalanceResponse.status:type_name -> bank.AccountStatus
	13, // 1: bank.HistoryResponse.transactions:type_name -> bank.TransactionRecord
	11, // 2: bank.ListAuditEventsResponse.events:type_name -> bank.BankAuditRecord
	1,  // 3: bank.TransactionRecord.status:type_name -> bank.TransactionStatus
	2,  // 4: bank.BankService.CreateUser:input_type -> bank.CreateUserRequest
	4,  // 5: bank.BankService.TransferMoney:input_type -> bank.TransferRequest
	6,  // 6: bank.BankService.GetBalance:input_type -> bank.BalanceRequest
	8,  // 7: bank.BankService.GetHistory:input_type -> bank.HistoryRequest
	10, // 8: bank.BankService.ListAuditEvents:input_type -> bank.ListAuditEventsRequest
	3,  // 9: bank.BankService.CreateUser:output_type -> bank.CreateUserResponse
	5,  // 10: bank.BankService.TransferMoney:output_type -> bank.TransferResponse
	7,  // 11: bank.BankService.GetBalance:output_type -> bank.BalanceResponse
	9,  // 12: bank.BankService.GetHistory:output_type -> bank.HistoryResponse
	12, // 13: bank.BankService.ListAuditEvents:output_type -> bank.ListAuditEventsResponse
