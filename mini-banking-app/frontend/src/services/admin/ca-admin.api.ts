...
// Cross-service audit views (timeline / verify / summary / export) moved to the
// Security Operations surface — see services/admin/soc-admin.api.ts. Admin CA is
// scoped to CA-domain audit only.
