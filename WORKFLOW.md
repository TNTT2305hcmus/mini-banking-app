...
- API Gateway forward vào internal services bằng `gRPC + TLS một chiều` (không dùng mTLS; network isolation trong Docker bảo vệ internal traffic).
...
| ADR-02 | Internal communication dùng gRPC + TLS một chiều, không dùng mTLS |
